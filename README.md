...
半斤九两科技 · EVEN BETTER  
专注 **外贸 + AI** 的真实落地：把产品、客户、渠道和团队流程，沉淀成客户看得懂、渠道跑得动、团队留得下的系统。

我更关心的不是“AI 能不能写一段很漂亮的话”，而是它能不能进入真实业务：整理资料、筛客户、做背调、写开发信、生成内容、沉淀 SOP，并让团队下一次做得更快一点。

## 推荐从这里开始

### 1. 外贸人 Codex 蓝皮书

[FloydTang/waimaoren-codex-bluebook](https://github.com/FloydTang/waimaoren-codex-bluebook)
...
以 Markdown 为真相源的 AI 长期记忆与检索引擎。面向长期使用的 AI Agent，不把记忆只交给一次性上下文。

## 我们的工作方法

- **Build 建资产**：产品页、案例页、FAQ、官网结构、信任证据、企业知识库。
- **Traffic 放流量**：内容 Brief、关键词、主动开发线索、客户背调、开发信和触达节奏。
- **Team 建系统**：AGENTS.md、Skills、SOP、检查清单、复盘表和团队 AI 工作流。
...
这里的仓库大多来自半斤九两自己的真实工作流。我们会优先开源那些能让外贸人、内容团队和 AI 使用者直接少走一点弯路的东西。
